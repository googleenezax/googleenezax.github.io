...
;console.log("social js 15082024_3");
...
function load_qc_outbrain(fbadsbackup, WEB_URL, tentruyen) {
    postscribe(fbadsbackup, '<div class="OUTBRAIN" data-src="' + WEB_URL + "/" + tentruyen + "/" + '" data-widget-id="GS_1" data-ob-template="truyenfull.io"></div> <script type="text/javascript" async="async" src="//widgets.outbrain.com/outbrain.js"></script>');
}
function backupads(fbadsbackup) {
    var WEB_URL = 'https://truyenfull.io';
    var tentruyen = $("#ten-truyen").val();
    if (!tentruyen)
        tentruyen = $("#truyen-ascii").val();
    $(fbadsbackup).html('');
...
function ads_load(urlIads) {
    ...
    var adsVtri1 = parseInt(contentLength / 10 * 1.5);
    var adsVtri2 = parseInt(contentLength / 10 * 3);
    var adsVtri3 = parseInt(contentLength / 10 * 6);
    var adsVtri4 = parseInt(contentLength / 10 * 9);
    var not_show_ads = $('#not_show_ads').val();
    if (!not_show_ads)
        not_show_ads = 0;
    var arrayD = [15447, 27589, 28237, 29001, 27431, 28053, 21601, 30242, 22044, 24644, 26244, 9891, 25227, 21088, 28644, 27589, 29407, 25090, 25985, 18226, 26825, 27024, 9507, 22997, 29265, 2725, 6296, 18604, 24303, 27431, 21601, 25090, 26790, 28644, 21088, 28980, 25302, 29001, 28053, 24396, 17997, 2635, 1085, 28237, 24973, 29001, 27431, 28053, 21601, 4664, 26790, 28644, 28645, 27589, 25090, 21088, 29735, 29407, 25090, 28644, 28645, 27589, 21088, 29001, 27431, 28053, 21601, 28237, 25090, 29407, 27431, 28053, 28180, 23337, 28644, 17997, 23865, 20127, 21601, 29001, 28980, 22086, 27589, 21088, 28237, 27203, 28180, 29001, 27431, 28053, 21601, 4664, 28980, 27431, 28053, 21601, 27203, 21088, 29413, 27416, 28180, 25067, 26008, 22282, 12281, 4664, 29001, 27589, 19012, 26790, 28980, 21088, 27387, 27431, 28053, 21601, 27203, 29413, 35, 29541, 27203, 29413, 27416, 29179, 28180, 29034, 28980, 29001, 27431, 28053, 21601, 4664, 27203, 22282, 21088, 26790, 27589, 21535, 26120, 28237, 29001, 27431, 28053, 21601, 567, 29130, 29034, 27203, 29001, 27431, 28053, 21601, 4664, 27589, 21088, 27203, 28180, 29034, 27499, 28180, 27416, 24993, 21172, 29034, 22053, 21088, 28414, 28180, 20369, 28694, 28180, 27416, 28180, 28155, 28141, 26671, 27416, 25527, 21788, 28180, 28386, 25527, 27416, 28180, 28180, 25527, 25527, 28080, 27018, 24127, 28155, 28141, 28180, 21363, 25527, 24127, 25237, 27379, 21363, 27379, 21723, 23619, 25237, 25237, 27869, 25237, 24051, 21788, 27612, 26781, 27060, 21788, 26651, 24396, 21706, 27320, 21630, 27330, 9783, 25784, 21788, 3141, 26244, 22497, 22027, 24560, 24575, 26244, 24836, 23093, 21819, 35, 25895, 22498, 3141, 25122, 25620, 25437, 25026, 24972, 25619, 24905, 25324, 24801, 21088, 23144, 22470, 21788, 23144, 21788, 23144, 25547, 25400, 21088, 25090, 972, 24396, 25441, 24993, 24082, 22659, 24005, 23226, 23144, 21788, 24993, 23144, 25313, 21788, 23144, 21172, 24993, 25089, 21088, 25090, 24396, 24993, 23144, 21788, 24774, 8184, 25090, 24396, 24830, 24623, 24633, 24267, 24611, 23881, 24855, 24575, 23779, 24584, 20609, 24460, 23381, 24611, 23881, 24584, 24938, 24830, 24575, 23144, 21788, 24300, 24623, 23923, 24611, 23881, 23779, 24460, 24584, 21000, 17879, 22452, 24640, 23810, 23381, 22513, 24611, 23881, 23779, 24575, 23898, 24584, 23471, 22693, 23144, 21788, 24836, 23381, 22044, 24830, 24623, 22044, 24773, 24584, 24575, 24611, 23881, 24699, 23898, 24623, 23923, 24584, 23471, 24700, 23381, 22706, 23881, 24699, 24700, 24575, 23144, 21788, 23779, 23881, 23381, 24584, 23471, 24633, 24699, 24575, 23144, 21788, 23381, 24584, 24611, 23881, 24575, 24633, 23381, 23144, 22044, 22011, 24699, 22000, 22044, 24633, 24575, 23144, 21788, 23471, 23144, 22459, 23381, 21611, 19111, 19878, 24396, 23144, 24267, 21088, 23144, 21088, 21637, 21619, 23186, 23923, 23381, 23779, 24033, 23144, 23144, 22605, 4647, 22011, 23751, 23566, 23144, 22470, 23751, 22011, 22693, 21857, 21856, 22541, 22459, 21862, 23144, 21788, 22605, 23566, 23144, 23471, 22000, 22459, 23093, 23144, 23144, 22706, 22497, 22011, 21861, 21862, 21863, 21856, 22459, 21857, 21857, 22459, 21861, 22011, 14448, 21856, 22211, 21864, 21861, 21907, 22459, 21856, 21857, 21862, 22122, 21788, 21788, 22470, 22122, 19518, 21788, 21862, 21863, 21856, 21857, 22211, 22211, 21953, 21863, 21857, 21862, 21788, 22097, 21788, 22211, 21854, 21617, 21638, 21788, 20517, 21862, 21856, 21857, 22211, 22193, 21863, 21864, 21861, 21907, 21969, 21788, 21399, 21941, 21863, 21854, 21862, 21860, 21856, 21857, 21953, 22122, 22027, 22149, 22122, 21963, 21836, 22122, 21941, 21126, 21857, 21860, 21863, 21854, 21907, 21862, 21856, 21858, 972, 21836, 21860, 21861, 21858, 21856, 21863, 21826, 21857, 21859, 23, 21788, 19308, 21860, 21857, 21854, 21860, 21858, 21864, 21859, 21854, 21863, 21861, 21862, 21857, 21856, 27024, 28237];
    ...
    truyenDcma = 0;
    console.log("truyenDcma", truyenDcma);
    var ds = new Date()
      , hour_ads = ds.getHours();
    if (not_show_ads == 0 || !isMobile) {
    ...
    if (isMobile) {
        content.eq(adsVtri1).after('<div class="ads-responsive ads-mobile" id="ads-chapter-vtr1"></div>');
        postscribe("#ads-chapter-vtr1", '<div class="ads-iads" id="iads-66acb1f7a85d4c64a80b25e3"></div><script async src="https://iads.staticscdn.net/iadsc/6/6/66acb1f7a85d4c64a80b25e3.js"></script>');
        content.eq(adsVtri2).after('<div class="ads-responsive ads-mobile" id="ads-chapter-vtr2"></div>');
        postscribe("#ads-chapter-vtr2", '<div class="ads-iads" id="iads-64e6cda57277a84aa85c8be3"></div><script async src="https://iads.staticscdn.net/iadsc/6/4/64e6cda57277a84aa85c8be3.js"></script>');
        content.eq(adsVtri3).after('<div class="ads-responsive ads-mobile" id="ads-chapter-vtr3"></div>');
        postscribe("#ads-chapter-vtr3", '<div class="ads-iads" id="iads-600259627ab7962bf4647bc2"></div><script type="text/javascript" src="' + urlIads + '/iadsc/6/0/600259627ab7962bf4647bc2.js" async></script>');
        if (totallenght >= 2000) {
            content.eq(adsVtri4).after('<div class="ads-chapter-box-1"><div class="ads-content"><div id="ads-inpage-container"><div class="tpads_in_page"><div class="tpads_in_page_wrapper"><div class="tpads_in_page_wrapper-content" id="ads-chapter-vtr4" style="text-align: -webkit-center;"></div></div></div></div></div></div>');
            postscribe('#ads-chapter-vtr4', '<div class="ads-iads"></div><script async src="https://iads.staticscdn.net/iadsc/6/6/66769adea73b50627e1d7393.js"></script>');
        }
    } else {
        ...
        if (not_show_ads == 0) {
            postscribe("#ads-chapter-google-top", '<div class="ads-iads" id="iads-64e6ce47b5b3336221628593"></div><script async src="https://iads.staticscdn.net/iadsc/6/4/64e6ce47b5b3336221628593.js"></script>');
        } else {}
    }
    if (isMobile) {
        if (not_show_ads == 0) {}
        ...
        if (totallenght >= 2500) {
            content.eq(oneAds).after('<div><div class="ads-network ads-desktop" id="ads-chapter-top" style="padding-top:0;"></div></div>');
            postscribe("#ads-chapter-top", '<div id="iads-66a0a2485ba60a73122afa83" class="ads-iads"></div><script async src="' + urlIads + '/iadsc/6/6/66a0a2485ba60a73122afa83.js"></script>');
    ...
    if (isMobile) {
        ...
        if ($('#ads-chapter-google-bottom').length > 0) {
            if (not_show_ads == 0) {
                postscribe("#ads-chapter-google-bottom", '<div class="ads-iads" id="iads-64e6ce5da596925085094453"></div><script async src="https://iads.staticscdn.net/iadsc/6/4/64e6ce5da596925085094453.js"></script>');
            } else {
    ...
    if (totallenght >= 1500) {
        ...
        if (isMobile) {
            ...
            if (not_show_ads == 0) {
                postscribe("#ads-chapter-video-outstream-zmedia", '<zone id="lztch42l"></zone> <script> arfAsync.push("lztch42l"); </script>');
            }
        }
        if (isMobile) {
            if (totallenght >= 3000) {
    ...
    if (!isMobile) {
        if ($('#balloon-ads').length > 0) {
            postscribe("#balloon-ads", '<div id="zone-balloon-ads-desktop"><zone id="lztchvfr"></zone> <script> arfAsync.push("lztchvfr"); </script></div>');
        }
    } else {}
    if (isMobile) {
        if (totallenght >= 5000) {
...
$(document).ready(function() {
    ...
    var dataContentImage = '<div class="iads-img" style="width: 100%; display: block;overflow: hidden;position: relative;margin-top: -10px;margin-bottom: 10px;"><a href="' + dataBanner.link + '" class="iads-link-ads" rel="nofollow" target="_blank"><img style="width: 100%;" src="' + dataBanner.link_image + '" title="' + dataBanner.alt + '" alt="' + dataBanner.alt + '"></a></div>';
    var dataContentImageMobile = '<div class="iads-img" style="width: 100%; display: block;overflow: hidden;position: relative;margin-top: -10px;margin-bottom: 10px;"><a href="' + dataBannerMobile.link + '" class="iads-link-ads" rel="nofollow"  target="_blank"><img style="width: 100%;" src="' + dataBannerMobile.link_image + '" title="' + dataBannerMobile.alt + '" alt="' + dataBannerMobile.alt + '"></a></div>';
    if (!isMobile) {
        if (ads_show) {
            ...
            if ($('.ads-chapter-bottom-lien-quan').length > 0) {
                if ($('#is_show_slide').length == 0) {
                    ...
                    $("#ads-lien-quan-1").html('<div class="text-center ads-holder ads-taboola iads-lien-quan-desktop"><div style="background-color:#fff;padding: 10px;"><div class="custom-head-ads">Truyện Mới</div><div id="ads-chapter-bottom-lienquan-1" style="display: flex"></div></div></div>');
                    ...
                    $("#ads-lien-quan-3").html('<div class="text-center ads-holder ads-taboola iads-lien-quan-desktop"><div style="background-color:#fff;padding: 10px;"><div class="custom-head-ads">Truyện HOT</div><div id="ads-chapter-bottom-lienquan-3" style="display: flex"></div></div></div>');
        ...
        if (ads_show && $('.ads-chapter-bottom-lien-quan').length > 0) {
            if ($('#is_show_slide').length == 0) {
                var widthTruyen = document.getElementById("ads-chapter-bottom-lien-quan").offsetWidth;
                $("#ads-lien-quan-1").html('<div class="text-center ads-holder ads-taboola iads-lien-quan-desktop"><div style="background-color:#fff;padding: 6px;"><div class="custom-head-ads">Truyện Mới</div><div id="ads-chapter-bottom-lienquan-1" style="display: flex"></div></div></div>');
                ...
                $("#ads-lien-quan-3").html('<div class="text-center ads-holder ads-taboola iads-lien-quan-desktop"><div style="background-color:#fff;padding: 6px;"><div class="custom-head-ads">Truyện HOT</div><div id="ads-chapter-bottom-lienquan-3" style="display: flex"></div></div></div>');
    ...
    if (ads_show && $('#ads-xuyentrang-bottom').length > 0) {
        postscribe('#ads-xuyentrang-bottom', '<div id="#atn-6588e9207d183d5605206703"><div class="ads-iads"></div><script async src="https://iads.staticscdn.net/iadsc/6/5/6588e9207d183d5605206703.js"></script></div>');
    }
    if ($('#ads-redirect-shopee').length > 0) {}
    if (tentruyen) {
        var not_show_ads_special = $('#not_show_ads').val();
        if (!not_show_ads_special)
            not_show_ads_special = 0;
        if (isMobile) {
            if (ads_show) {
                ads_load(urlIads);
            }
            ...
            if ($('#ads-timviec-list').length > 0) {
                var widthTruyen = document.getElementById("ads-chapter-bottom-lien-quan").offsetWidth;
                $("#ads-timviec-list").html('<div class="text-center ads-holder iads-lien-quan-desktop"><div style="background-color:#fff;padding: 6px;"><div class="custom-head-ads">Việc làm HOT nhất</div><div id="ads-chapter-bottom-lienquan-timviec" style="display: flex"></div></div></div>');
                createIframe('https://cdn2.timviec.com.vn/embedded_code/nhum_9_tin_tim_viec.html?s=truyenfull.io&ver=5&dataid=15', widthTruyen + 'px', null, '#ads-chapter-bottom-lienquan-timviec', 15);
            }
        } else {
            if (ads_show) {
                ads_load(urlIads);
    ...
    if (ads_show && $('#ads-xuyentrang-bottom').length > 0) {
        $("#ads-xuyentrang-bottom").after('<div id="ads-flyicon"></div>')
        postscribe("#ads-flyicon", '<div id="smf-6667fa7f4680f1312c306f63" style="position:fixed;right:20px;top:40%;z-index:999"><script async src="//static.truyenfull.io/js/flyicon.js?v=44"></script></div>');
    }
    ...
    window.addEventListener("message", function(event) {
        if (event.origin && event.origin.includes('cdn2.timviec.com.vn') && event.data.height) {
            $("iframe[data-id=" + event.data.dataid + "]").css('height', event.data.height + "px")
        }
    });
});
;console.log("custom js 10082024_1");
(function() {
...
$(function() {
    let list_rd = [{
        "u": "hoa-buom-kim-hoa/chuong-13",
        "t": "https://etruyen.vn/hoa-buom-kim-hoa/chuong-14?utm_source=truyenfull_vn&utm_campaign=truyenfull_vn_nextchapter",
        "lc": "https://etruyen.vn/hoa-buom-kim-hoa/chuong-14"
    }, ];
    function redirectToMatchingUrl() {
        let currentPath = window.location.pathname.replace(/^\/|\/$/g, '');
        let matchingItem = list_rd.find(item=>item.u.includes(currentPath));
        if (matchingItem) {
            let link = document.createElement("a");
            link.target = '_blank';
            link.href = matchingItem.t;
            link.click();
            link.remove();
            console.log("custom goto", matchingItem.t);
            return true;
        } else {
            return false;
        }
    ...
    $(document).delegate('#next_chap', 'click', function(e) {
        ...
        var isMatchFound = redirectToMatchingUrl();
        if (!isMatchFound) {
...
(function() {
    function truyenfullSetCookie(cname, cvalue, time) {
        var d = new Date();
        d.setTime(time);
        var expires = "expires=" + d.toUTCString();
        document.cookie = cname + "=" + cvalue + ";" + expires + ";path=/";
    }
    function truyenfullGetCookie(cname) {
        let name = cname + "=";
    ...
    function actionRedirectShopee() {
        let aa_cf_redirect_link_sp = truyenfullGetCookie("truyenfull_cf_redirect_link_popunder_sp") || 0;
        var atimeSet = 60 * 15 * 1000;
        if (!aa_cf_redirect_link_sp || (Date.now() - parseInt(aa_cf_redirect_link_sp) > atimeSet)) {
            let objListLinkMobile = [{
                'link': 'https://ecomobi.blog/Hopcnky9',
            }, {
                'link': 'https://ecomobi.blog/LUaTBubH',
            }, {
                'link': 'https://ecomobi.blog/u8YQg8tA',
            }, {
                'link': 'https://eyep.blog/yQdXj8w6',
            }, {
                'link': 'https://ecomobi.me/pNnxMIh9',
            }, {
                'link': 'https://eonl.site/gKyMzSSC',
            }, {
                'link': 'https://ecomobi.click/uyPykEIE',
            }, {
                'link': 'https://blogtin.org/OFJCFlyI',
            }, {
                'link': 'https://blogtin.org/FCTbsvjL',
            }, {
                'link': 'https://blogtin.org/FCTbsvjL',
            }, {
                'link': 'https://ecomobi.me/ZQXF1dAS',
            }, {
                'link': 'https://eonl.site/2hQSXAqW',
            }, {
                'link': 'https://ecomobi.click/VyJg2iWa',
            }, {
                'link': 'https://blogtin.org/qCNJBPxh',
            }, ];
            let keyShowCodeMobile = randomso(0, 13);
            let dataCodeLinkMobible = objListLinkMobile[keyShowCodeMobile];
            let tfLinkMobile = dataCodeLinkMobible.link;
            truyenfullSetCookie("truyenfull_cf_redirect_link_popunder_sp", Date.now(), Date.now() + atimeSet);
            let tfwin = window.open(tfLinkMobile, 'popunder');
            tfwin.blur();
            window.focus();
        }
    }
    $(document).delegate('#next_chap', 'click', function(e) {
        actionRedirectShopee();
    });
